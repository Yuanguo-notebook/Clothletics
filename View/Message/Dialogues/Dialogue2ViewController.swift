...
class Dialogue2ViewController: DialogueViewController {
...
extension Dialogue2ViewController{
    ...
    private func setupDialogue1(){
        ...
        designer1_photo.image = UIImage(named:"message_photo2")
    ...
    private func setupUserLabel(){
        ...
        user_label.text = "Hi, are you there? I want to change to a larger size. I think that would fit me better."
